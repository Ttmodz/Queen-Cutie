...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp...')}`);
    ...
    conn.on('open', async () => {
        ...
        if (config.AFPLK == 'THESANDU' || config.AFPLK == 'thesandu' || config.AFPLK == 'Thesandu' || config.AFPLK == 'pinky') {
        //thanks to afnanplk
        console.log(
            chalk.green.bold('thanks for watching -key cofirmed-')
        );
         }
         else if (config.AFPLK !== 'THESANDU' || config.AFPLK !== 'thesandu' || config.AFPLK !== 'Thesandu' || config.AFPLK !== 'pinky') {
         console.log(
        ...
        console.log(
            chalk.green.bold('𝚀𝚞𝚎𝚎𝚗𝙲𝚞𝚝𝚒𝚎 𝚠𝚘𝚛𝚔𝚒𝚗𝚐 ' + config.WORKTYPE + ' 𝚗𝚘𝚠 🍃'));
    ...
    setInterval(async () => { 
        ...
        var ansk = 'https://gist.github.com/Ttmodz/990794cbe26dd78db7e68c0d364a5c8c/raw'
...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~_________~ 👸QueenCutie👑 ~______~*' +
                                    '\n*🌀 Contact QueenCutie other wise chance to get erorr: https://wa.me/+94712564306*' +
                                    '\n\n*⚠️ ' + error + '*\n'
                                    , MessageType.text);
                            }
                        }
