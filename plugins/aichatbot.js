...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to Queen-Cutie voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
var succ_off = ''
if (conf.LANG == 'TR') {
    AI_dsc = 'Tam fonksiyonel Queen-Cutie özelliklerini aktif eder. Hesabınızı bir chatbota dönüştürün!'
    already_on = 'Queen-Cutie yapay zekası halihazırda tüm fonksiyonları etkin.'
    already_off = 'Queen-Cutie yapay zekası halihazırda yarı fonksiyonel çalışıyor.'
    succ_on = 'Queen-Cutie, Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
    succ_off = 'Queen-Cutie, Yarı Fonksiyonel Olarak Ayarlandı! Lütfen Biraz Bekleyin! ☑️'
}
if (conf.LANG == 'EN') {
    AI_dsc = 'Activates full functional Queen-Cutie features. Turn your account into a ai chatbot!'
    already_on = 'Queen-Cutie artificial intelligence is already fully functional.'
    already_off = 'Queen-Cutie artificial intelligence is currently running semi-functional.'
    succ_on = "Queen-Cutie's AI chatbot open. Restarting and applying changes ! ✅"
    succ_off = "Queen-Cutie's AI chatbot turned off. Restarting and applying changes ! ✅"
}
if (conf.LANG == 'ML') {
