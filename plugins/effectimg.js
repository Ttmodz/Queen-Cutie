...
if (Config.WORKTYPE == 'private') {
    ...
    await message.sendMessage('?’»Usage: *.glitch*\n?¹ï?Desc: It Sends a glitch style image of the text provided.\nYou must enter the heading and subheading seperated by */* in order!.\n\n?’»Usage: *.pornhub*\n?¹ï?Desc: It Sends a blackish orange coloured image of the text provided.\nYou must enter the heading and subheading seperated by */* in order!.\n\n?’»Usage: *.sandwriting*\n?¹ï?Desc: It Sends a sand image of the text provided.\n\n?’»Usage: *.blackpink*\n?¹ï?Desc: It Sends a blackish pink image of the text provided.\n\n?’»Usage: *.lovemsg*\n?¹ï?Desc: It Sends love message style image of the text provided.\n\n?’»Usage: *.grass*\n?¹ï?Desc: It Sends a grass image of the text provided.\n\n?’»Usage: *.blood*\n?¹ï?Desc: It Sends a blood image of the text provided.\n\n?’»Usage: *.romance*\n?¹ï?Desc: It Sends a green image with love shapes of the text provided.\n\n?’»Usage: *.candlemug*\n?¹ï?Desc: It Sends a mug image of the text provided.\n\n?’»Usage: *.snow*\n?¹ï?Desc: It Sends a snow image of the text provided.\n\n?’»Usage: *.cloud*\n?¹ï?Desc: It Sends a sky image of the text provided\n\n?’»Usage: *.underwater*\n?¹ï?Desc: It Sends a ocean image of the text provided\n\n?’»Usage: *.flower*\n?¹ï?Desc: It Sends a flower image of the text provided\n\n?’»Usage: *.burn*\n?¹ï?Desc: It Sends a half burned paper image of the text provided\n\n?’»Usage: *.candy*\n?¹ï?Desc: It Sends a candy image of the text provided\n\n?’»Usage: *.wood*\n?¹ï?Desc: It Sends a wood carved image of the text provided.\n\n?’»Usage: *.latte*\n?¹ï?Desc: It put the text as latte art within a coffee cup.\n\n?’»Usage: *.8bit*\n?¹ï?Desc: Converts the text into an 8bit style image.\nYou must enter the heading and subheading seperated by */* in order!\n\n?’»Usage: *.shadow*\n?¹ï?Desc: Converts the text into shadow themed image.\n\n?’»Usage: *.harrypotter*\n?¹ï?Desc: Converts the text into a harrypotter themed image.\n\n?’»Usage: *.sparkling*\n?¹ï?Desc: Converts the text into a sparkling themed image\nYou must enter the heading and subheading seperated by */* in order!\n\n?’»Usage: *.watercolour*\n?¹ï?Desc: Converts the text into a watercolour themed image.\n\n?’»Usage: *.ninjalogo*\n?¹ï?Desc: Enters the text as the caption for a ninja themed logo.\n\n?’»Usage: *.neonlight*\n?¹ï?Desc: Converts the text into a neonlight themed image.\n\n?’»Usage: *.3dtext*\n?¹ï?Desc: Converts the provided text into a 3D style image.');
